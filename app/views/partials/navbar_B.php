...
<header>
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
        ...
        <ul class="navbar-nav me-auto ms-4 mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a href="#" class="nav-link <?= ($page_name == 'events_B') ? 'current-nav-item' : '' ?>">Events</a></li>
            <li class="nav-item"><a href="#" class="nav-link <?= ($page_name == 'gift_cards_B') ? 'current-nav-item' : '' ?>">Gift Cards</a></li>
        </ul>
        </div>
        ...
        <?php if(isUserLoggedIn()): ?>
            <nav class="nav-icons">
                ...
                <a href="<?= base_url('my_account_B') ?>" class="account-btn">
